            ...
            <div className="min-h-screen bg-white flex flex-col items-center px-6 pt-12 pb-10 font-sans">
                ...
                <div className="w-full bg-[#FAFBFF] rounded-[28px] p-6 mb-12 shadow-sm border border-gray-50 flex flex-col gap-5">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-gray-900 font-black text-[17px]">1771138859799</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 px-1">
                        <div className="flex justify-between items-center text-sm">
                            ...
                            <span className="text-gray-900 font-bold">Hotel Sandeep</span>
                        </div>
                        <div className="flex justify-between items-center text-sm">
                ...
                <div className="w-full flex flex-col gap-4 mt-auto">
                    <button 
                         ...
                         className="w-full bg-[#FF584A] text-white font-black text-[17px] py-5 rounded-xl shadow-lg shadow-red-100 hover:bg-[#E5483B] transition-all active:scale-[0.98]"
                    >
                        Track Order
                    </button>
                    <button 
                        onClick={() => navigate('/')}
                        className="w-full bg-white text-gray-900 border border-gray-100 font-black text-[17px] py-5 rounded-xl hover:bg-gray-50 transition-all active:scale-[0.98]"
                    >
                        Back to Home
                    </button>
                </div>
