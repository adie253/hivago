...
const filters = [
    { name: 'Pure Veg', active: false },
    { name: 'Rating 4.0+', active: false },
...
export const FilterChips: React.FC = () => {
    return (
        <div className="w-full flex items-center gap-3 md:gap-4 px-4 md:px-12 pb-6 md:pb-8 border-b border-gray-100 font-sans overflow-x-auto no-scrollbar">
            ...
            {/* Filter Icon button */}
            <button className="bg-[#FF4732] text-white p-2.5 md:p-3 rounded-xl shadow hover:bg-orange-700 transition-colors flex-shrink-0">
