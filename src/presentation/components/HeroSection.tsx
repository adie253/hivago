...
export const HeroSection: React.FC = () => {
    return (
        <div className="bg-gradient-to-r from-[#EB5C4F] to-[#A41B0E] w-full shadow-sm min-h-[225px] lg:min-h-[250px] flex flex-col lg:flex-row items-center justify-between px-6 md:px-12 lg:px-25 py-12 lg:py-16 relative overflow-hidden font-sans gap-12 lg:gap-4">
            ...
            <div className="z-10 w-full lg:w-3/4 flex flex-row items-center justify-between gap-4 lg:gap-8">
                ...
                <div className="w-[65%] lg:w-1/2 flex flex-col font-poppins">
                    ...
                    <p className="text-red-100 mt-4 leading-3.5 max-w-[130px] text-[12px] md:text-lg font-poppins font-weight-400">
                ...
                <div className="w-[35%] lg:w-1/2 flex justify-center lg:justify-end relative items-center">
                    ...
                    <div className="relative inline-block z-10 w-full max-w-[120px] sm:max-w-[200px] md:max-w-[380px] lg:max-w-[350px]">
                        ...
                        <div className="absolute mt-5 top-1/2 left-1/2 ml-[-20px] -translate-x-1/2 -translate-y-1/2 w-[120%] h-[130%] -z-10 text-brand-secondary opacity-100">
                            <img src={blob_bg} alt="" className="w-full h-full object-contain" />
                        </div>

                        {/* Discount Badge */}
                        <div className="hidden md:block absolute top-4 -left-4 lg:-left-8 bg-white rounded-full p-2 shadow-xl transform -rotate-12 z-20">
                        ...
                        <img
                            ...
                            className="w-full position-absolute top-10 -left-8 object-contain drop-shadow-[0_10px_20px_rgba(0,0,0,0.3)] relative z-10 hover:scale-105 transition-transform duration-500 ease-out"
                        />
                    </div>
                </div>
            </div>
