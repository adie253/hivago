...
export const HeroSection: React.FC = () => {
    return (
        <div className="bg-[#FF4732] w-full   mt-4 shadow-sm min-h-[300px] lg:min-h-[250px] flex flex-col lg:flex-row items-center justify-between px-6 md:px-12 lg:px-25 py-12 lg:py-16 relative overflow-hidden font-sans gap-12 lg:gap-4">
            ...
            <div className="z-10 hidden lg:flex w-full lg:w-1/4 justify-center lg:justify-start lg:-mt-10">
                <div className="bg-white rounded-3xl p-4 md:p-6 shadow-xl w-56 md:w-64 transform lg:-rotate-3 hover:rotate-0 transition-transform duration-300 relative cursor-pointer group">
                    ...
                    <p className="font-extrabold text-lg md:text-xl text-gray-800 group-hover:text-[#FF4732] transition-colors">5k Happy reviews</p>
                </div>
            </div>
            ...
            <div className="z-10 w-full lg:w-1/3 flex justify-center lg:justify-end relative mt-8 lg:mt-0 items-center">
                ...
                <div className="relative inline-block z-10 w-full max-w-[260px] sm:max-w-[320px] md:max-w-[380px] lg:max-w-[350px]">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[130%] h-[130%] -z-10 text-[#FF6B55] opacity-100">
                    ...
                    <div className="absolute top-4 -left-4 lg:-left-8 bg-white rounded-full p-2 shadow-xl transform -rotate-12 z-20">
                        <div className="border-[2px] border-dashed border-[#FF4732] rounded-full w-14 h-14 flex flex-col items-center justify-center text-[#FF4732] font-black leading-[1.1] text-xs">
