    ...
    const renderOfferCard = (id: string, title: string) => {
        ...
        return (
            ...
            >
                ...
                <div className={`w-6 h-6 rounded-md border-2 flex items-center justify-center transition-colors ${isSelected ? 'border-brand-primary bg-brand-primary' : 'border-gray-200'}`}>
            ...
            <div className="bg-[#F8FAFC] w-full max-w-md sm:rounded-3xl rounded-t-3xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh] min-h-[80vh] animate-in slide-in-from-bottom-full sm:slide-in-from-bottom-5 duration-300 relative">
                ...
                <div className="flex-1 overflow-y-auto no-scrollbar bg-[#F8FAFC] p-4 sm:p-5 pb-8 border-t border-gray-100">
                    ...
                    >
                        ...
                        />
                        <button type="submit" className="text-brand-primary font-bold px-5 py-3">
                            Apply
                        </button>
                    </form>
                    ...
                    {/* See More button */}
                    <button className="w-full bg-brand-light text-brand-primary rounded-2xl py-4 flex items-center justify-center gap-2 font-bold mt-2 transition-colors active:scale-[0.98]">
                ...
                <div className="bg-white p-4 border-t border-gray-100 shrink-0 shadow-[0_-10px_20px_rgba(0,0,0,0.03)] pb-safe sm:pb-4">
                    <button
                        onClick={onClose}
                        className="w-full bg-brand-primary text-white font-bold text-[17px] py-[16px] rounded-xl shadow-md hover:bg-brand-secondary transition-colors active:scale-[0.98]"
                    >
                        Apply
                    </button>
                </div>
